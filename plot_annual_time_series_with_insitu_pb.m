...
hyeararrows(1) = annotation('textarrow',[0.345 0.345], [0.97 0.9],'LineWidth',1.5,'Color','k');
% hyeararrows(2) = annotation('textarrow',[0.517 0.517], [0.91 0.81],'LineWidth',1.5,'Color','k');
hyeararrows(3) = annotation('textarrow',[0.691 0.691], [0.97 0.9],'LineWidth',1.5,'Color','k');
...
% print([InDir1,'chl_annual_time_series_insitu_',season,'.tif'],'-r300','-dtiff');
...
for ista = [1,3:6,8:17,19:21]
    ...
    %     'VerticalAlignment','bottom');
    hp2b(ista)=plot(year_range',insitu_means(insitu_means.Station==ista,:).mean_insitu_secchi_mean,':o',...
        'MarkerSize',10,'LineWidth',1.5,'Color',C(ista,:));
...
% print([InDir1,'secchi_annual_time_series_insitu_',season,'.tif'],'-r300','-dtiff');
